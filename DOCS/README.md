...
supabase/
  ...
  seed.sql             base card catalog (104 cards)
  seed_sets/           imported sets (m19.sql: Core Set 2019), generated by scripts/import-scryfall-set.mjs
...
scripts/               import-scryfall-set.mjs (add a whole set), download-card-art.ps1 (art → Storage)
