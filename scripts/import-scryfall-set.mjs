...
//        common → UNLIMITED · uncommon/rare → UNLOCK · mythic → UNIQUE
...
function toSeedSql(set, rows) {
  const cols = 'id, oracle_id, forge_name, rarity, ownership_type, set_code, mana_value, types, colors, image_url, discoverable, spawn_region, weight, commander_eligible'
